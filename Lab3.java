...
public class Lab3 {
    public static void main(String[] args)
    {
		...
		selection = JOptionPane.showConfirmDialog(null,"Would you lke to play a dice rolling game?\nYou start out with "
				+ "R200 and are able to bet", "Dice Game Begin 1", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
    ...
    // Deduct the bet amount only if it's valid and less than or equal to the available money
    if (bet > 0 && bet <= money) {
        money -= bet;
    }
}
